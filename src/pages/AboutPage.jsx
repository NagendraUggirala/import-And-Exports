  ...
  const milestones = [
    {
      ...
      title: "Foundation",
      description:
        "Anand Imports & Exports established with vision of ethical global trade",
    },
    {
      year: "2005",
      title: "Expansion",
      description: "Expanded trade network across Asia and Middle East regions",
    },
    {
      year: "2014",
      title: "Consolidation",
      description:
        "Unified operations and established strong international partnerships",
    },
    {
      year: "2025",
      title: "Innovation",
      description:
        "Launched advanced export solutions and diversified product portfolio",
    },
  ];
  ...
  const values = [
    {
      ...
      description:
        "Complete legal documentation and honest communication in every transaction",
    },
    {
      icon: "⭐",
      title: "Quality Excellence",
      description:
        "Uncompromised construction standards using premium materials and techniques",
    },
    {
      icon: "⚖️",
      title: "Vastu Science",
      description:
        "Modern architecture harmonized with scientific Vastu principles for balanced living",
    },
    {
      icon: "🌍",
      title: "Accessible Luxury",
      description:
        "Premium living experiences made accessible to everyone without compromise",
    },
  ];
  ...
  const sectors = [
    {
      ...
      description:
        "Creating dream spaces with legal transparency and Vastu compliance",
      stats: "50+ Projects",
    ...
    },
    {
      ...
      description:
        "Building sustainable infrastructure with uncompromised quality standards",
    ...
    },
    {
      ...
      description:
        "Telling meaningful stories that reflect our creative vision and values",
          ...
          >
            ...
            >
              <div className="inline-block bg-white/10 backdrop-blur-sm rounded-2xl p-4 md:p-8 border border-white/20 shadow-2xl mx-2">
                ...
                <div className="text-sm sm:text-base md:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed px-2">
                  Where righteousness protects the protector, and ethical
                  practices build lasting legacies.
                </div>
              </div>
            </motion.div>
            ...
            >
              <p className="text-sm sm:text-base md:text-lg text-blue-100 leading-relaxed px-2 sm:px-4">
                For over two decades, we've built not just trade partnerships,
                but trust. Our journey is guided by the timeless wisdom that
                when you protect Dharma (righteousness), Dharma protects you in
                return.
              </p>
            </motion.div>
          </motion.div>
                  ...
                  >
                    <div className="bg-gradient-to-r from-blue-50/50 to-orange-50/50 rounded-xl p-4 md:p-6 border-l-4 border-orange-500 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:border-orange-600 mx-2 sm:mx-0">
                      <p className="text-gray-700 italic text-sm sm:text-base md:text-lg leading-relaxed text-center">
                        "We connect markets across continents. Every trade we
                        facilitate is backed by complete documentation, quality
                        assurance, and a vision for sustainable global commerce.
                        Our partnerships aren't just transactions; they're
                        bridges that foster economic growth and prosperity
                        worldwide."
                      </p>
                    </div>
                  </motion.div>
                ...
                <div className="w-full">
                  ...
                  <div className="mt-4 md:mt-6 text-gray-700 space-y-4 w-full">
                    <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                      A visionary leader with an unwavering commitment to
                      excellence, Anand founded Anand Imports & Exports with a
                      simple yet powerful vision: to bridge global markets and
                      create sustainable trading partnerships that transform
                      businesses.
                    </p>
                    <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                      With a background in engineering and an innate
                      understanding of market dynamics, Mr. Anand has
                      successfully steered the group through economic cycles,
                      expanding from domestic trading to a global enterprise
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 md:p-6 mt-4 border-l-4 border-blue-500">
                      ...
                      <p className="text-gray-700 text-xs sm:text-sm md:text-base">
                        Under Anand's leadership, Anand Imports & Exports has
                        emerged as a trusted global trading partner. We
                        specialize in the smooth movement of quality goods
                        across borders, ensuring reliability, transparency, and
          ...
          >
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-2 sm:px-4">
                Delivering premium Indian products to global markets with
                consistency, trust, and international trade expertise.
              </p>
            </motion.div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4 text-left">
                        <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
                          Anand Imports & Exports specializes in sourcing,
                          packaging, and exporting high-quality Indian products
                          worldwide. Our strong supplier network, strict quality
                          control, and seamless logistics allow us to provide
                          export-ready products that meet international
                          compliance and customer expectations.
                        </p>
                        <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
                          From agricultural produce and spices to textiles and
                          industrial supplies, we ensure every shipment reflects
                          our commitment to quality, authenticity, and
                          reliability.
                        </p>
                      </div>
                    </div>
              ...
              <motion.div variants={itemVariants} className="flex">
                <div className="bg-gradient-to-br from-orange-50 to-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-lg border border-orange-100 hover:shadow-xl hover:border-orange-200 transition-all duration-300 flex flex-col h-full w-full">
                  <div className="flex flex-col h-full justify-between">
                    <div>
                      <h3 className="text-base sm:text-lg md:text-xl font-bold text-blue-800 mb-2 text-left">
                        Our Journey in International Trade
                      </h3>
                      <div className="space-y-4 text-left">
                        <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-4">
                          What began with export supply to select regions has
                          now expanded into a diverse global network serving
                          multiple countries across Asia, the Middle East,
                          Europe, and beyond. Yet, our foundation remains
                          unchanged: delivering value with professionalism,
                          transparent communication, and ethical trade
                          practices.
                        </p>
                        <ul className="list-disc list-inside space-y-2 text-sm sm:text-base md:text-lg text-gray-700 ml-2">
                          ...
                          <li>International export standards</li>
                          <li>Transparent process and documentation</li>
                          <li>Efficient packaging and global shipping</li>
                        </ul>
                      </div>
                    </div>
                  </div>
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed mb-6 md:mb-8 px-2 sm:px-4">
                Anand Imports & Exports is a dynamic global trading enterprise
                committed to connecting national and international markets. We
                specialize in the seamless movement of high-quality goods across
                borders, ensuring reliability, transparency, and value in every
                transaction. Through strong sourcing networks, strategic
                partnerships, and an unwavering commitment to excellence, Anand
                Group stands as a trusted trading partner for businesses
                worldwide.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-blue-200 mb-6 md:mb-8 max-w-2xl mx-auto px-2 sm:px-4">
              Discover how Anand Imports & Exports' commitment to quality and
              trust can transform your global trading partnerships and expand
              your business reach.
            </p>
